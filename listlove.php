								...
								?>
									<tbody>
										<?php foreach($data as $key => $item):?>
											<tr>
												<td title="Xem Phim" class="w3-list-img"><a href="single.php?id=<?= $item['IDFILM'] ?> & id2= <?= $item['IDTHELOAI'] ?>"><img src="<?= $item['HINH'] ?>" alt="" /> <span><?= $item['TENFILM'] ?></span></a></td>
												<td><?= $item['NAMSX'] ?></td>
												<td>HD</td>
												<td class="w3-list-info"><a href="quocgia.php"><?= $item['TENQUOCGIA'] ?></a></td>
												<td class="w3-list-info"><a href="theloai.php"><?= $item['TENTHELOAI'] ?></a></td>
												<td><?= $item['SORATING'] ?> <a href="#"><i class="fa fa-star" aria-hidden="true"></i></a></td>
											</tr>
										<?php endforeach?>
									</tbody>
