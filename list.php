			   ...
			   <div class="header-w3-agileits" id="home">
				...
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							...
							<li><a href="cart.php"  >Phim yêu thích <span class="badge badge-light" id="count">0</span></a></li> 
						</ul>
			...
			<!--/content-inner-section-->
				<div class="w3_content_agilleinfo_inner">
						...
						<div class="inner-agile-w3l-part-head">
					            <h3 class="w3l-inner-h-title">Danh Sách Tìm Kiếm</h3>
						</div>
					<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
						...
						?>
								...
								?>		
										<tbody>
										  <tr>
											<td title = "Xem Phim"class="w3-list-img"><a href="single.php?id=<?= $row['IDFILM']?> & id2= <?= $row['IDTHELOAI']?>"><img src="<?= $row['HINH'] ?>" alt="" /> <span><?= $row['TENFILM'] ?></span></a></td>
											<td><?= $row['NAMSX'] ?></td>
											<td>HD</td>
											<td class="w3-list-info"><a href="quocgia.php"><?= $row['TENQUOCGIA'] ?></a></td>
											<td class="w3-list-info"><a href="theloai.php"><?= $row['TENTHELOAI'] ?></a></td>
											<td><?= $row['SORATING'] ?>  <a href="#"><i class="fa fa-star" aria-hidden="true"></i></a></td>
										  </tr>
