...
<!--/main-header-->
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
								...
								<ul class="dropdown-menu multi-column columns-3">
									...
									<div class="col-sm-4">
										<ul class="multi-column-dropdown">
											<li><a href="phimhai.php">Phim hài</a></li>	
											<li><a href="tinhcam.php">Phim tình cảm</a></li>											
										</ul>
									</div>
									<div class="col-sm-4">
										<ul class="multi-column-dropdown">
											<li><a href="kinhdi.php">Phim kinh dị</a></li>
											<li><a href="hoathinh.php">Phim hoạt hình</a></li>
											
										</ul>
									</div>
									<div class="col-sm-4">
										<ul class="multi-column-dropdown">
											<li><a href="hanhdong.php">Phim hành động</a></li>
										</ul>
									</div>
							...
							<li class="dropdown">
								...
								<li>
										<div class="col-sm-4">
											<ul class="multi-column-dropdown">
												<li><a href="nation_vn.php">Việt Nam</a></li>										
												<li><a href="nation_US.php">Mỹ</a></li>
											</ul>
										</div>
										<div class="col-sm-4">
											<ul class="multi-column-dropdown">
												<li><a href="nation_china.php">Trung Quốc</a></li>
												<li><a href="nation_japan.php">Nhật Bản</a></li>
											</ul>
										</div>
										<div class="col-sm-4">
											<ul class="multi-column-dropdown">
												<li><a href="nation_korean.php">Hàn Quốc</a></li>
												<li><a href="nation_hongkong.php">Hồng Kông</a></li>
											</ul>
										</div>
										<div class="clearfix"></div>
									</li>
 ...
 <!--//main-header-->
			...
			<!--/content-inner-section-->
				<div class="w3_content_agilleinfo_inner">
					<div class="agile_featured_movies">
						<!--/comedy-movies-->
					<h3 class="agile_w3_title hor-t">Phim<span> Việt Nam</span> </h3>
					 <div class="wthree_agile-requested-movies tv-movies">
						...
						?>	
										<div class="col-md-2 w3l-movie-gride-agile requested-movies">
															<a href="single.php?id=<?= $row['IDFILM']?>" class="hvr-sweep-to-bottom"><img src="<?= $row['HINH'] ?>" title="Xem phim" class="img-responsive" alt=" ">
			...
			<!--//comedy-movies-->
					...
					<!--/tv-movies-->
			<h3 class="agile_w3_title">Phim<span> Trung Quốc</span> </h3>
					 <div class="wthree_agile-requested-movies tv-movies">
					 <?php
										require_once('conn.php');
			...
			<h3 class="agile_w3_title">Phim<span> Nhật Bản</span> </h3>
					 <div class="wthree_agile-requested-movies tv-movies">
					 <?php
										require_once('conn.php');
			...
			<h3 class="agile_w3_title">Phim<span> Hàn Quốc</span> </h3>
					 <div class="wthree_agile-requested-movies tv-movies">
					 <?php
										require_once('conn.php');
			...
			<h3 class="agile_w3_title">Phim<span> Hồng Kông</span> </h3>
					 <div class="wthree_agile-requested-movies tv-movies">
					 <?php
										require_once('conn.php');
			...
			<h3 class="agile_w3_title"> Phim <span> Mỹ</span></h3>			
