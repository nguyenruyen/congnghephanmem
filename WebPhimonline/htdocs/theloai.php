...
<!--/main-header-->
								...
								<ul class="dropdown-menu multi-column columns-3">
									...
									<div class="col-sm-4">
										<ul class="multi-column-dropdown">
											<li><a href="phimhai.php">Phim hài ABC</a></li>	
 ...
 <!--//main-header-->
			  ...
			  <div class="w3_agilits_banner_bootm">
			     <div class="w3_agilits_inner_bottom">
			            <div class="col-md-6 wthree_agile_login">
						     <ul>
									<li><i class="fa fa-phone" aria-hidden="true"></i> (+84) 93081299 ABC</li>
			...
			<!--/content-inner-section-->
				<div class="w3_content_agilleinfo_inner">
					<div class="agile_featured_movies">
						<!--/comedy-movies-->
					<h3 class="agile_w3_title hor-t">Phim<span> Tình cảm</span> </h3>
			...
			<!--//comedy-movies-->
					<!--/tv-movies-->
			<h3 class="agile_w3_title">Phim<span> Hài</span> </h3>
					 <div class="wthree_agile-requested-movies tv-movies">
					 <?php
										require_once('conn.php');
			...
			<h3 class="agile_w3_title">Phim<span> Kinh dị</span> </h3>
					 <div class="wthree_agile-requested-movies tv-movies">
					 <?php
										require_once('conn.php');
			...
			<h3 class="agile_w3_title"> Phim <span> Hành động</span></h3>			
