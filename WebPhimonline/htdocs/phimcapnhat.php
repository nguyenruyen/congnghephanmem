...
<html >
<head>
<title> Lập trình mã nguồn mở | AnhVinh & ThuPhuong & Ngọc Hiền</title>
<!-- for-mobile-apps -->
				...
				<div class="breadcrumb-inner">	
				     ...
				     <div class="wthree_agile-requested-movies">		
											...
											<div class="col-md-2 w3l-movie-gride-agile requested-movies">
												<a href="single.php?id=<?= $row['IDFILM']?>& id2= <?= $row['IDTHELOAI']?>" class="hvr-sweep-to-bottom"><img src="<?= $row['HINH'] ?>" title="Click để xem phim" class="img-responsive" alt=" ">
